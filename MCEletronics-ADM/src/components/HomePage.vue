    ...
    <div class="container">
      ...
      <form class="md-layout" @submit.prevent="saveProduct">
        ...
        <b-button type="submit" style="margin-top:3% " class="float-right" variant="primary">
          Salvar
          <i class="material-icons" alt="salvar">save</i>
        </b-button>
      </form>
        ...
        <tbody>
          <tr :key="product.id" v-for="product in products">
            ...
            <td>
              ...
              <b-button @click="show(product)" alt="ver" style="margin: 1%" variant="primary">
              ...
              <b-button @click="remove(product.id)" variant="danger" alt="remover">
