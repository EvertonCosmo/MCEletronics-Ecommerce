<template>
  <div>
    ...
    <section style="width: 100%; margin-top: 1%; margin-bottom: 8px" >
        ...
        <div class="selection-box" style="max-width: 55rem; width: 100%; display: block; margin-bottom: 5%" >
            <div class="container">
                            ...
                            <div class="row" >
                                <div class="col-12 col-sm-12 col-md-2 text-center">
                                    <img class="img-responsive" src="http://placehold.it/120x80" alt="prewiew" width="120" height="80">
                                     <img :src="require(`/home/emanoel/Documentos/MCEletronics/MCEletronics-ADM/src/assets/${this.product.id}.jpg`)" width="100%" height="70%"/>
                                     <b-img :src="require(`/home/emanoel/Documentos/MCEletronics/MCEletronics-ADM/src/assets/${product.id}.jpg`)" fluid-grow></b-img>
                                </div>
        ...
        <div class="purchase-information">
            ...
            <b-button style= "background-color:#033076; height: 15%; margin-top: 1%; margin-bottom: 5%" type="submit"  block variant="primary">
